    ...
    <div class="flex flex-col flex-1">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container px-6 mx-auto grid">
                ...
                <form class="grid" action="{{ route('update_kategori', $kategori->id_kategori) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-2 md:grid-cols-2 xl:grid-cols-2">
                        <div class="px-4 py-3 mb-2 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <label class="block text-sm">
                                ...
                                <div
                                    ...
                                    <input required value="{{ $kategori->kategori }}" name="kategori"
                        ...
                        <div class="px-4 py-3 mb-2 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <label class="block text-sm">
                                ...
                                <div
                                    class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                                    <input required value="{{ $kategori->deskripsi }}" name="deskripsi"
                                        class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
